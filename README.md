...
FSC1 has been minted into final slices. `FSC1-S01` through `FSC1-S03` are accepted, and the current manager-focus slice is `FSC1-S04` foundation operator contracts; `FSC1-S05` is also internally eligible inside the same chunk.
