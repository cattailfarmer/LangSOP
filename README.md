...
FSC1 has been minted into final slices. The current ready slice is `FSC1-S01` kernel record core schema; the remaining FSC1 slices are gated on accepted outputs inside the same chunk.
